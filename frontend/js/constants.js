const contractAddress = "0x322070FEE3d21A5BD0414C85d94f1FEc77919131"; //Replace with your own contract address
const chain = 'polygon'; // rinkeby or polygon

const welcome_h1 = "Welcome to the OnlineTroops NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The OnlineTroops NFT Project is a decentralized project. Each NFT has been generated from over 400 unique layers. All of the troops are waiting to be adopted and let out of their carriers. Be sure to join our community to be alerted when new groups of soldiers are dropped.';
...
const p_presale_coming_soon = "We are working hard to launch the NFT Collection and Its Coin. Stay tuned for updates!";
